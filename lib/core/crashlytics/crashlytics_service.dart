...
class CrashlyticsService {
  ...
  /// 2. This generates `lib/firebase_options.dart` automatically
  /// 3. Import the generated file in this file (see commented code below)
  /// 4. Uncomment the Firebase initialization code in the method below
  ///
  /// Parameters:
  /// - `enableInDebug`: Set to true to enable Crashlytics in debug mode (default: false)
  /// - `environment`: The current app environment for environment-aware configuration
  ///
  /// Example:
  /// ```dart
  ...
  static Future<void> initialize({
    ...
    try {
      ...
      //
      // IMPORTANT: Follow these steps to enable Firebase:
      // 1. Run: flutterfire configure
      // 2. This generates lib/firebase_options.dart
      // 3. TODO: Uncomment the import at the top of this file:
      //    import 'package:riverpod_go_router_boilerplate/firebase_options.dart';
      // 4. TODO: Uncomment the code below:
      ...
      // Fallback: Initialize without options (uses google-services.json / GoogleService-Info.plist)
      // This works but is not recommended for production. Uncomment the Firebase code above instead.
      if (Firebase.apps.isEmpty) {
        await Firebase.initializeApp();
      }
