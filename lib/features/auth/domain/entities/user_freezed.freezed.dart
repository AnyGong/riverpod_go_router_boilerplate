...
class _User implements User {
  const _User({required this.id, required this.email, this.name, this.avatarUrl, this.isEmailVerified = false, this.createdAt});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ApiSuccess<T> value)?  success,TResult Function( ApiError<T> value)?  error,TResult Function( ApiLoading<T> value)?  loading,required TResult orElse(),}){
final _that = this;
switch (_that) {
case ApiSuccess() when success != null:
return success(_that);case ApiError() when error != null:
return error(_that);case ApiLoading() when loading != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ApiSuccess<T> value)  success,required TResult Function( ApiError<T> value)  error,required TResult Function( ApiLoading<T> value)  loading,}){
final _that = this;
switch (_that) {
case ApiSuccess():
return success(_that);case ApiError():
return error(_that);case ApiLoading():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ApiSuccess<T> value)?  success,TResult? Function( ApiError<T> value)?  error,TResult? Function( ApiLoading<T> value)?  loading,}){
final _that = this;
switch (_that) {
case ApiSuccess() when success != null:
return success(_that);case ApiError() when error != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( String message,  String? code)?  error,TResult Function()?  loading,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ApiSuccess() when success != null:
return success(_that.data);case ApiError() when error != null:
return error(_that.message,_that.code);case ApiLoading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( String message,  String? code)  error,required TResult Function()  loading,}) {final _that = this;
switch (_that) {
case ApiSuccess():
return success(_that.data);case ApiError():
return error(_that.message,_that.code);case ApiLoading():
return loading();}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( String message,  String? code)?  error,TResult? Function()?  loading,}) {final _that = this;
switch (_that) {
case ApiSuccess() when success != null:
return success(_that.data);case ApiError() when error != null:
return error(_that.message,_that.code);case ApiLoading() when loading != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiError<T>&&(identical(other.message, message) || other.message == message)&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'ApiResponse<$T>.error(message: $message, code: $code)';
}
...
class ApiLoading<T> implements ApiResponse<T> {
  const ApiLoading();
